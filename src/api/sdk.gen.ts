 ...
 */
export const getBarberByUserId = <ThrowOnError extends boolean = false>(options: Options<GetBarberByUserIdData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetBarberByUserIdResponse, GetBarberByUserIdError, ThrowOnError>({
...
export const getUpcomingAppointments = <ThrowOnError extends boolean = false>(options: Options<GetUpcomingAppointmentsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetUpcomingAppointmentsResponse, GetUpcomingAppointmentsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
...
export const getPastAppointments = <ThrowOnError extends boolean = false>(options: Options<GetPastAppointmentsData, ThrowOnError>) => {
    return (options.client ?? _heyApiClient).get<GetPastAppointmentsResponse, GetPastAppointmentsError, ThrowOnError>({
        security: [
            {
                scheme: 'bearer',
                type: 'http'
